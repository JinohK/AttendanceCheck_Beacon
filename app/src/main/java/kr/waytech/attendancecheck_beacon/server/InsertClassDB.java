 ...
 */
public class InsertClassDB extends AsyncTask<String, Integer, String> {
    public static final String strUrl = "http://waytech.kr/AtdCheck/insertClass.php";
    public static final int HANDLE_INSERT_FAIL = 326346;
    public static final int HANDLE_INSERT_OK = 5856765;
    ...
    public InsertClassDB(Handler mHandler) {
